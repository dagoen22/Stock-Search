...
class InfomoneyStrategy(StockData):
    ...
    def get_info(self, name: str):
        try:
            ...
            if request.status_code != 200:
                ...
                raise NotFoundStockData(f"Cannot find the requested stock data from infomoney, {stock_url}")
    ...
    def value_open(self):
        ...
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[1]/div[1]/span[2]")[0].text
    
    @property
    def previous_close(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[1]/div[2]/span[2]")[0].text
    
    @property
    def minimal(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[1]/div[3]/span[2]")[0].text
    
    @property
    def maximum(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[1]/div[4]/span[2]")[0].text
    
    @property
    def day_variation(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[2]/div[1]/span[2]/text()")[1].strip()
    
    @property
    def month_variation(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[2]/div[2]/span[2]/text()")[1].strip()    

    @property
    def year_variation(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[2]/div[3]/span[2]/i")[1].strip()
    
    @property
    def variation_ft_weeks(self):
        return self.dom.xpath("//html/body/main/section/div/div/div[4]/div[2]/div[4]/span[2]/i")[0].text
    
    @property
    def volume(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[3]/div[1]/span[2]")[0].text
    
    @property
    def bss_volume(self):
        return self.dom.xpath("/html/body/main/section/div/div/div[4]/div[3]/div[2]/span[2]")[0].text
